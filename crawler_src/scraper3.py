...
class Scraper_17k:
    ...
    def getTitle(self):
        ...
        title = ""
        try:
            var = self.soup.find("div", "Info Sign")
            if not var:
                var = self.soup.find("div", "Info")
            var = var.find("h1").find("a")
    ...
    def getDescription(self):
        ...
        try:
            ...
            if not var:
                var = self.soup.find("div", "Info")
            var = var.find("dl", "Tab").find("dd").find("div", "cont").find("a")
    ...
    def getBookType(self):
        ...
        try:
            var = self.soup.find("div", "Info Sign")
            if not var:
                var = self.soup.find("div", "Info") # For some specify web
            var = var.find("dl", "Tab")
